<head>
    ...
    <title>AginBlog Bootstrap Template - Index</title>
    <meta content="" name="description">
    <meta content="" name="keywords">
  
    <!-- Favicons -->
    <link href="/client_assets/img/favicon.png" rel="icon">
    <link href="/client_assets/img/apple-touch-icon.png" rel="apple-touch-icon">
    ...
    <link href="/client_assets/css/variables.css" rel="stylesheet">
