...
<head>
    ...
    <body class="container mt-5">
        <div class="card">
            <form action="{{ route('admin.login.doLogin') }}" method="POST" class="py-3 py-md-5 py-xl-8"> 
                @csrf 
                <div class="container">
                <div class="row">
                    <div class="col-12">
                    <div class="mb-5">
                        ...
                        <p class="text-center m-0">Don't have an account? <a href="{{ route('admin.register.index') }}">Sign up</a></p>
                    </div>
                    </div>
                </div>
                    ...
                    <div class="row gy-5 justify-content-center">
                        ...
                        <form action="#!">
                            ...
                            <div class="col-12">
                                ...
                                <input value="{{ old('email') }}" type="email" class="form-control border-0 border-bottom rounded-0" name="email" id="email" placeholder="name@example.com" @error('title') is-invalid @enderror required>
                            ...
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                <input type="password" class="form-control border-0 border-bottom rounded-0" name="password" id="password" value="" placeholder="Password" required @error('title') is-invalid @enderror>
